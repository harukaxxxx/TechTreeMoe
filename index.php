  ...
  <body>
      ...
      <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="collapse-head">
          <div class="am-topbar-right">
            <button id="mmm" class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="mmm();">
              <span class="am-icon-toggle-off">
              </span> 萌萌模式
            </button>
            <button id="submit" class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="submit();" data-am-loading="{spinner: 'circle-o-notch', loadingText: '提交中...'}">
              <span class="am-icon-download">
              </span> 下載
            </button>
          </div>
        </div>
    ...
    <div class="top">
      <div class="am-g">
        <div class="am-u-lg-12">
          <h1 class="top-title" tkey="tkey_site_title">TechTreeMoe - 戰艦世界科技樹萌化
          </h1>
          <p tkey="tkey_site_description">
            結合艦隊收藏、戰艦少女、鋼鐵少女、碧藍航線、最終戰艦、Victory Belles以及同人作品，讓科技樹萌起來吧！
          </p>
          <button type="button" class="am-btn am-btn-primary" data-am-modal="{target: '#preview'}">效果預覽
          </button>
        </div>
      </div>
    </div>
    <div class="am-modal am-modal-alert" tabindex="-1" id="preview">
      <div class="am-modal-dialog">
        <div class="am-modal-hd" tkey="tkey_preview_button">效果預覽
        </div>
            ...
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/japan.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_japan">日本預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/usa.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_usa">美國預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/germany.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_germany">德國預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/ussr.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_ussr">蘇聯預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/uk.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_uk">英國預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/france.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_france">法國預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/italia.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_italia">義大利預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/commonwealth.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_commonwealth">聯邦預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/pan_asia.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_pan_asia">泛亞預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/poland.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_poland">波蘭預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/arp.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_arp">蒼藍鋼鐵戰艦預覽
                  </h3>
                </a>
              </div>
            </li>
            <li>
              <div class="am-gallery-item">
                <a href="images/preview/haifuri.jpg" class="">
                  ...
                  <h3 class="am-gallery-title" tkey="tkey_preview_haifuri">高校艦隊預覽
                  </h3>
                </a>
              </div>
            </li>
        ...
        <div class="am-modal-footer">
          <span class="am-modal-btn" tkey="tkey_close">關閉
          </span>
        </div>
      </div>
    </div>
        ...
        <div class="am-u-lg-12">
          ...
          <div class="am-g">
            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12 intro-mb">
              <h3 class="intro-h3" tkey="tkey_intro_title">
                <i class="am-icon-info-circle">
                </i> 介紹
              </h3>
              <ul class="intro-p">
                <li tkey="tkey_intro_1">艦娘圖標百百種，挑選中意的圖標來萌化科技樹。
                </li>
                <li tkey="tkey_intro_2">利用
                  <span class="am-icon-paint-brush am-text-primary"> 可更替
                  </span> 按鈕可快速尋找可以替換的項目
                </li>
                <li tkey="tkey_intro_3">按下
                  <span class="am-icon-download am-text-primary"> 下載
                  </span>時將使用LocalStorage儲存您的紀錄。
                </li>
                <li tkey="tkey_intro_4">此模組不包含背景國旗及艦型小圖標。
                </li>
              </ul>
            </div>
            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12 intro-mb">
              <h3 class="intro-h3" tkey="tkey_tutorial_title">
                <i class="am-icon-book">
                </i> 教學
              </h3>
              <ol class="intro-p">
                <li tkey="tkey_tutorial_1">艦船圖片下的下拉選單可選取並預覽想使用的圖標。
                </li>
                <li tkey="tkey_tutorial_2">挑選完畢後再點擊右上的
                  <span class="am-icon-download am-text-primary"> 下載
                  </span> 按鈕進行下載。
                </li>
                <li tkey="tkey_tutorial_3">耐心等待下載完成。
                </li>
                <li tkey="tkey_tutorial_4">解壓縮後將gui資料夾複製到
                  <code>res_mods/x.x.x/
                  </code>裡即可。
                </li>
              </ol>
    ...
    <div class="mixitup">
      <div class="filter-group">
        <div class="am-btn-group">
          <button type="button" class="am-btn am-btn-primary am-btn-sm am-round" onclick="filterReset();" tkey="tkey_filter_all">全部顯示
          </button>
        </div>
        ...
        <div class="am-btn-group" data-am-button>
          <label class="am-btn am-btn-primary am-btn-sm am-round">
            <input type="radio" class="options" name="type" value=".destroyer" tkey="tkey_filter_destroyer">
            <span class="am-icon-paint-anchor">
            </span>驅逐艦
          </label>
          <label class="am-btn am-btn-primary am-btn-sm am-round">
            <input type="radio" class="options" name="type" value=".cruiser" tkey="tkey_filter_cruiser">
            <span class="am-icon-paint-anchor">
            </span>巡洋艦
          </label>
          <label class="am-btn am-btn-primary am-btn-sm am-round">
            <input type="radio" class="options" name="type" value=".battleship" tkey="tkey_filter_battleship">
            <span class="am-icon-paint-anchor">
            </span>戰艦
          </label>
          <label class="am-btn am-btn-primary am-btn-sm am-round">
            <input type="radio" class="options" name="type" value=".aircarrier" tkey="tkey_filter_aircarrier">
            <span class="am-icon-paint-anchor">
            </span>航空母艦
          </label>
        </div>
        <div class="am-btn-group" data-am-button>
          <label class="am-btn am-btn-primary am-btn-sm am-round">
            <input type="radio" class="options" name="extra" value=".change" tkey="tkey_filter_change">
            <span class="am-icon-paint-brush">
            </span>可更替
          </label>
          <label class="am-btn am-btn-primary am-btn-sm am-round am-icon-premium">
            <input type="radio" class="options" name="extra" value=".premium" tkey="tkey_filter_premium">
            <img src="./images/icons/premium_icon.png">加值艦
          </label>
        </div>
        <div class="am-btn-group">
        ...
        <div class="am-u-lg-12">
          ...
          <div class="am-g about-box">
            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12">
              <h4 class="about-color" tkey="tkey_contact_title">
                <i class="am-icon-paper-plane">
                </i> 聯絡我們
              </h4>
              <p tkey="tkey_contact_content">若您發現任何問題請至
                <a href="https://github.com/harukaxxxx/WOWS-TechTreeMoe/issues">Github
                </a>建立Issues回報！
                <br>（網站Bug、艦船缺漏、素材提供、功能建議等）
              </p>
              <h4 class="about-color" tkey="tkey_detail-title">
                <i class="am-icon-question-circle">
                </i> 詳細資訊
              </h4>
...
?>
            ...
            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12">
              <h4 class="about-color" tkey="tkey_log_title">
                <i class="am-icon-list-ul">
                </i> 更新紀錄
              </h4>
...
?>
            ...
            <button type="button" class="am-btn thanks-btn am-btn-block" data-am-modal="{target: '#thanks'}">特別感謝
            </button>
            <div class="am-popup" id="thanks">
              <div class="am-popup-inner">
                <div class="am-popup-hd">
                  <h4 class="am-popup-title">特別感謝名單
                  </h4>
                  <span data-am-modal-close class="am-close">&times;
                  </span>
                </div>
                <ul class="am-list am-list-static">
                  <li>
                    ...
                    <a href="http://blog.sina.com.cn/u/3027377595">bluekiller
                    </a>】 - 碧藍航線立繪提供
                  </li>
                  <li>
                    <i class="am-icon-user am-icon-fw">
                    </i>【
                    <a href="https://home.gamer.com.tw/homeindex.php?owner=kakushi03004">紙龜萌萌雪
                    </a>】 - 碧藍航線立繪提供
                  </li>
                  <li>
                    <i class="am-icon-user am-icon-fw">
                    </i>【
                    <a href="https://home.gamer.com.tw/homeindex.php?owner=kkkkking12">阿爽
                    </a>】 - 鋼鐵少女立繪提供
                  </li>
                  <li>
                    <i class="am-icon-user am-icon-fw">
                    </i>【
                    <a href="https://home.gamer.com.tw/homeindex.php?owner=ae033179">Adam Richter
                    </a>】 - 鋼鐵少女立繪提供
                  </li>
                  <li>
                    <i class="am-icon-user am-icon-fw">
                    </i>【
                    <a href="https://home.gamer.com.tw/homeindex.php?owner=roderichlind">Blomkavist
                    </a>】 - 新船資訊提供
                  </li>
                  <li>
                    <i class="am-icon-user am-icon-fw">
                    </i>【
                    <a href="http://srarithmetic.com/">Nacht
                    </a>】 - 更新紀錄與詳細資訊背景圖提供
                    <a href="https://www.pixiv.net/member_illust.php?mode=medium&illust_id=51816460">
                      <i class="am-icon-external-link">
                      </i>
                    </a>
                  </li>
                  <li>
                    <i class="am-icon-globe am-icon-fw">
                    </i>【
                    <a href="https://victorybelles.tumblr.com/">Victory Belles
                    </a>】 - Victory Belles立繪提供
                  </li>
                  <li>
                    <i class="am-icon-globe am-icon-fw">
                    </i>【
                    <a href="http://fleet.diablohu.com/">是誰呼叫艦隊
                    </a>】 - 艦隊收藏立繪提供
                  </li>
                  <li>
                    <i class="am-icon-globe am-icon-fw">
                    </i>【
                    <a href="https://www.zjsnrwiki.com/wiki">艦R百科
                    </a>】 - 戰艦少女立繪提供
                  </li>
                </ul>
              </div>
...
?>
          <div class="am-g">
            <div class="am-u-md-4">
              <div class="card-box">
                <span class="text-muted am-fr">
                  <?php echo date("Y年m月d日",time()); ?>
                </span>
                <h4 class="header-title">本日下載量
                </h4>
            ...
            <div class="am-u-md-4">
              <div class="card-box">
                <span class="text-muted am-fr">
                  <?php echo date("Y年m月",time()); ?>
                </span>
                <h4 class="header-title">本月下載量
                </h4>
                <div class="widget-chart">
                  <h2> 
                    <?php echo $monthly."次"; ?> 
            ...
            <div class="am-u-md-4">
              <div class="card-box">
                <span class="text-muted am-fr">2017年09月04日至今
                </span>
                <h4 class="header-title">總下載量
                </h4>
                <div class="widget-chart">
                  <h2> 
                    <?php echo $rdata->overtime."次"; ?> 
                  </h2>
                </div>
              </div>
            </div>
...
?>             
          ...
          <div class="am-g">
            <div class="am-u-md-12">
              <div class="card-box">
                <h4 class="header-title">各國萌化進度
                </h4>
                <div  id="nationComplete" style="width: 100%;height: 400px;">
                </div>
              </div>
            </div>
          </div>
          <div class="am-g">
            <div class="am-u-md-12" >
              <div class="card-box">
              <h4 class="header-title">每日下載量折線圖
                </h4>
                <div id="daily">
                </div>
              </div>
    ...
    <div data-am-widget="gotop" class="am-gotop am-gotop-fixed">
      <a href="#top" title="回到顶部">
        <span class="am-gotop-title">回到顶部
        </span>
        <i class="am-gotop-icon am-icon-chevron-up">
        </i>
      </a>
    </div>
    <?php 
...
?>
    <footer class="footer">
      <p>Designed by © 2010 
        ...
        <a href="http://amazeui.org/"> AMAZE UI
        </a>｜
