    ...
    <div class="am-container">
      ...
      <div class="am-collapse am-topbar-collapse" id="collapse-head">
        <ul class="am-nav am-nav-pills am-topbar-nav">
          <li>
            <a href="#intro">介紹與教學</a>
          </li>
          <li>
            <a href="#mixitup">客製化</a>
          </li>
          <li>
            <a href="#about">更新紀錄與詳細資訊</a>
          </li>
          <li>
            <a href="#charts">統計數據與萌化進度</a>
          </li>
        </ul>
        <div class="am-topbar-right">
          <button id="mmm" class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="mmm();">
            <span class="am-icon-toggle-off"></span> 萌萌模式
          </button>
          <button id="submit" class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="submit();" data-am-loading="{spinner: 'circle-o-notch', loadingText: '提交中...'}">
            <span class="am-icon-download"></span> 下載
          </button>
        </div>
      </div>
    </div>
        ...
        <div class="am-g about-box">
          <div class="am-u-lg-6 am-u-md-6 am-u-sm-12">
            <h4 class="about-color" tkey="tkey_contact_title">
              <i class="am-icon-paper-plane"></i> 聯絡我們
            </h4>
            ...
            <h4 class="about-color" tkey="tkey_detail-title">
              <i class="am-icon-question-circle"></i> 詳細資訊
            </h4>
...
?>
    <footer class="footer">
      <p>Designed by
        <a class="hidden" href="assets/php/clean.php">©</a> 2010
